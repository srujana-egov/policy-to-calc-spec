...
*already-written* policy documents (`prototype/`, `DEMO-2026-07-13.md`) — that's a fourth,
...
that) and the sibling `PolicyRule[]` extraction path (`prototype/`, a separate tool for the
document-backlog use case, not part of these three).
